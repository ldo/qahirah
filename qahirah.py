...
cairo.cairo_set_source_rgba.restype = None
cairo.cairo_set_source.argtypes = (ct.c_void_p, ct.c_void_p)
cairo.cairo_set_source.restype = None
...
cairo.cairo_set_tolerance.restype = None
cairo.cairo_clip.argtypes = (ct.c_void_p,)
cairo.cairo_clip.restype = None
cairo.cairo_clip_preserve.argtypes = (ct.c_void_p,)
cairo.cairo_clip_preserve.restype = None
...
cairo.cairo_rectangle_list_destroy.restype = None
...
cairo.cairo_copy_page.restype = None
cairo.cairo_show_page.argtypes = (ct.c_void_p,)
cairo.cairo_show_page.restype = None
...
cairo.cairo_path_destroy.restype = None

cairo.cairo_select_font_face.argtypes = (ct.c_void_p, ct.c_char_p, ct.c_int, ct.c_int)
cairo.cairo_select_font_face.restype = None
cairo.cairo_set_font_size.argtypes = (ct.c_void_p, ct.c_double)
cairo.cairo_set_font_size.restype = None
cairo.cairo_set_font_matrix.argtypes = (ct.c_void_p, ct.c_void_p)
cairo.cairo_set_font_matrix.restype = None
cairo.cairo_get_font_matrix.argtypes = (ct.c_void_p, ct.c_void_p)
...
cairo.cairo_set_scaled_font.restype = None
...
# actually I’m assuming user-font functions are always present
cairo.cairo_user_font_face_create.argtypes = ()
...
cairo.cairo_user_font_face_set_init_func.restype = None
...
cairo.cairo_user_font_face_set_render_glyph_func.restype = None
...
cairo.cairo_user_font_face_set_unicode_to_glyph_func.restype = None
...
cairo.cairo_user_font_face_set_text_to_glyphs_func.restype = None
...
cairo.cairo_show_text.restype = None
cairo.cairo_show_glyphs.argtypes = (ct.c_void_p, ct.c_void_p)
cairo.cairo_show_glyphs.restype = None
...
cairo.cairo_surface_status.restype = ct.c_int
cairo.cairo_surface_status.argtypes = (ct.c_void_p,)
cairo.cairo_surface_get_type.restype = ct.c_int
...
cairo.cairo_surface_get_font_options.restype = None
...
cairo.cairo_format_stride_for_width.restype = ct.c_int
cairo.cairo_format_stride_for_width.argtypes = (ct.c_int, ct.c_int)
# actually I’m assuming image-surface functions are always present
...
cairo.cairo_image_surface_create_from_png.argtypes = (ct.c_char_p,)
...
cairo.cairo_image_surface_get_format.restype = ct.c_int
cairo.cairo_image_surface_get_format.argtypes = (ct.c_void_p,)
cairo.cairo_image_surface_get_width.restype = ct.c_int
cairo.cairo_image_surface_get_width.argtypes = (ct.c_void_p,)
cairo.cairo_image_surface_get_height.restype = ct.c_int
cairo.cairo_image_surface_get_height.argtypes = (ct.c_void_p,)
cairo.cairo_image_surface_get_stride.restype = ct.c_int
cairo.cairo_image_surface_get_stride.argtypes = (ct.c_void_p,)

# actually I’m assuming PDF surface functions are always present
...
cairo.cairo_pdf_surface_restrict_to_version.restype = None
cairo.cairo_pdf_surface_restrict_to_version.argtypes = (ct.c_void_p, ct.c_int)
cairo.cairo_pdf_get_versions.restype = None
...
cairo.cairo_pdf_surface_set_size.restype = None
...
#end if
# actually I’m assuming PostScript surface functions are always present
...
cairo.cairo_ps_surface_restrict_to_level.restype = None
cairo.cairo_ps_surface_restrict_to_level.argtypes = (ct.c_void_p, ct.c_int)
cairo.cairo_ps_get_levels.restype = None
...
cairo.cairo_ps_surface_set_eps.restype = None
...
cairo.cairo_svg_surface_restrict_to_version.restype = None
cairo.cairo_svg_surface_restrict_to_version.argtypes = (ct.c_void_p, ct.c_int)
cairo.cairo_svg_get_versions.restype = None
...
#end if
# actually I’m assuming recording-surface functions are always present
...
cairo.cairo_recording_surface_ink_extents.restype = None
...
cairo.cairo_device_status.restype = ct.c_int
cairo.cairo_device_status.argtypes = (ct.c_void_p,)
cairo.cairo_device_get_type.restype = ct.c_int
cairo.cairo_device_get_type.argtypes = (ct.c_void_p,)

# actually I’m assuming script-surface functions are always present
...
cairo.cairo_script_from_recording_surface.restype = ct.c_int
...
cairo.cairo_script_set_mode.restype = None
...
cairo.cairo_script_write_comment.restype = None
...
cairo.cairo_pattern_status.restype = ct.c_int
cairo.cairo_pattern_destroy.argtypes = (ct.c_void_p,)
cairo.cairo_pattern_destroy.restype = None
...
cairo.cairo_pattern_get_rgba.restype = ct.c_int
...
cairo.cairo_pattern_get_linear_points.restype = ct.c_int
...
cairo.cairo_mesh_pattern_curve_to.restype = None
cairo.cairo_mesh_pattern_set_control_point.argtypes = (ct.c_void_p, ct.c_uint, ct.c_double, ct.c_double)
cairo.cairo_mesh_pattern_set_control_point.restype = None
...
cairo.cairo_mesh_pattern_set_corner_color_rgb.restype = None
...
cairo.cairo_mesh_pattern_set_corner_color_rgba.restype = None
cairo.cairo_mesh_pattern_get_patch_count.argtypes = (ct.c_void_p, ct.c_void_p)
cairo.cairo_mesh_pattern_get_patch_count.restype = ct.c_int
...
cairo.cairo_mesh_pattern_get_control_point.restype = ct.c_int
...
cairo.cairo_mesh_pattern_get_corner_color_rgba.restype = ct.c_int
...
cairo.cairo_region_status.restype = ct.c_int
cairo.cairo_region_status.argtypes = (ct.c_void_p,)
cairo.cairo_region_destroy.restype = None
...
cairo.cairo_region_get_extents.restype = None
cairo.cairo_region_get_extents.argtypes = (ct.c_void_p, ct.c_void_p)
cairo.cairo_region_num_rectangles.restype = ct.c_int
cairo.cairo_region_num_rectangles.argtypes = (ct.c_void_p,)
cairo.cairo_region_get_rectangle.restype = None
...
cairo.cairo_region_translate.restype = None
...
cairo.cairo_font_options_status.restype = ct.c_int
cairo.cairo_font_options_status.argtypes = (ct.c_void_p,)
cairo.cairo_font_options_create.restype = ct.c_void_p
cairo.cairo_font_options_create.argtypes = ()
cairo.cairo_font_options_destroy.restype = None
...
cairo.cairo_font_options_merge.restype = None
...
cairo.cairo_font_face_destroy.restype = None
cairo.cairo_font_face_destroy.argtypes = (ct.c_void_p,)
cairo.cairo_font_face_status.restype = ct.c_int
cairo.cairo_font_face_status.argtypes = (ct.c_void_p,)
cairo.cairo_font_face_get_type.restype = ct.c_int
cairo.cairo_font_face_get_type.argtypes = (ct.c_void_p,)
cairo.cairo_font_face_set_user_data.restype = ct.c_int
...
cairo.cairo_toy_font_face_get_slant.restype = ct.c_int
cairo.cairo_toy_font_face_get_slant.argtypes = (ct.c_void_p,)
cairo.cairo_toy_font_face_get_weight.restype = ct.c_int
...
cairo.cairo_ft_font_options_substitute.restype = None
...
cairo.cairo_ft_font_face_set_synthesize.restype = None
cairo.cairo_ft_font_face_set_synthesize.argtypes = (ct.c_void_p, ct.c_uint)
cairo.cairo_ft_font_face_unset_synthesize.restype = None
...
cairo.cairo_glyph_allocate.argtypes = (ct.c_int,)
cairo.cairo_glyph_free.restype = None
cairo.cairo_glyph_free.argtypes = (ct.c_void_p,)
cairo.cairo_text_cluster_allocate.restype = ct.c_void_p
cairo.cairo_text_cluster_allocate.argtypes = (ct.c_int,)
cairo.cairo_text_cluster_free.restype = None
...
cairo.cairo_scaled_font_destroy.restype = None
cairo.cairo_scaled_font_destroy.argtypes = (ct.c_void_p,)
cairo.cairo_scaled_font_status.restype = ct.c_int
